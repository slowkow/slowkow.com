...
```{r plot-sparsity, echo = FALSE, fig.width = 2, fig.height = 2}
d_sparse <- data.frame(
  x = rev(rep(1:10, 10)),
  y = rep(1:10, each = 10),
  color = FALSE
...
```{r pca-density, echo=FALSE, fig.width=12, fig.height=3}
...
```{r pca-density-adjusted, echo=FALSE, fig.width=12, fig.height=3}
