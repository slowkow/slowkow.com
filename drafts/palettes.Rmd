...
```{r scico1, warning = FALSE, echo = FALSE, dpi = 300, fig.width = 2, fig.asp = 1.62}
library("scico")
library("ggplot2")
...
```{r distiller, warning = FALSE, fig.height = 3.75, fig.width = 1.8, echo = FALSE, dpi = 300}
# n <- 1e3
# d <- expand.grid(
#   x = seq(1, n),
#   y = seq(1, n)
...
```{r colorspace1, warning = FALSE, echo = FALSE, dpi = 300, fig.width = w, fig.height = h}
library("colorspace")
